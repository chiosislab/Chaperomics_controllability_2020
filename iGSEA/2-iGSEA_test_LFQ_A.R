...
## Human AD up/down
data.up   <- input [input$LFQ.A.p <= 0.1 & input$LFQ.A.FC > 1,]
...
write.csv (list.chaperome.input.fulltable [,grep ("^MS.MS",colnames(list.chaperome.input.fulltable))],"list.chaperome.csv")
write.csv (list.chaperome.input.fulltable.mean ,"list.chaperome.input.fulltable.mean.csv")
